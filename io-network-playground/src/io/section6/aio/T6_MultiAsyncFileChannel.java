...
public class T6_MultiAsyncFileChannel {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        asyncChannel.write(buffer, 1024, "Async write (1KB): ", new CompletionHandler<Integer, String>() {
            @Override
        ...
        asyncChannel.write(buffer, 0, "Async write (0KB): ", new CompletionHandler<Integer, String>() {
            @Override
            public void completed(Integer result, String attachment) {
                System.out.println(attachment + result + " bytes");
                latch.countDown();
